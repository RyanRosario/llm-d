...
- **[`GKESnapshotProvider`](file:///usr/local/google/home/ryanrosario/Code/llm-d/docker/scripts/snapshot/providers.py)**: Manages gVisor checkpoint trigger via `/proc/gvisor/checkpoint` and cache purging.
